# Operator Quickstart — Secondary Education

Shortest path from clone to a verified local dry-run for **ISIC 852** (`cloud-itonami-isic-852`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-852.git
cd cloud-itonami-isic-852
```
...
- Blueprint governor key: `secondaryops-governor`
- Likely source path: `secondaryops.governor.cljc`
